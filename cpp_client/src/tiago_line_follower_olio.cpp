    ...
    void LineFolloModule()const {
        ...
        if(GS_middle.range>0.1 && GS_LIGHT.data>500){
            ...
            */ 
            ...
            // else if(GS_LEFT.data>=500 && GS_RIGHT.data >=500){ // dritto
            ...
            if(GS_LEFT.data>=500 || GS_RIGHT.data >=500){  // Siamo dentro lo slittamento

                RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Una delel due ruote è sopra l'olio");
            ...
            else{ // siamo al di fuori dello slittamento...

                RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Fase di non slittamento");
