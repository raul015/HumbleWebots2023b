...
auto GS_middle = std_msgs::msg::Float64();
auto GS_light = std_msgs::msg::Float64();
auto stato = std_msgs::msg::Int64();
...

{
  public:
    ...
    rclcpp::Publisher<std_msgs::msg::Int64>::SharedPtr stato_linea;
    ...
    subMiddle = this->create_subscription<sensor_msgs::msg::Range>("tiago_middle",10, std::bind(&LineFollower::middleSensor_cb, this, std::placeholders::_1));
    ...
    stato_linea = this->create_publisher<std_msgs::msg::Int64>("stato_linea", 10);
    ...
    void LineFolloModule()const {
        ...
        if(GS_middle.data>300 && GS_light.data > 10){
            ...
            */ 
            ...
            if(GS_LEFT.data >= 500 || GS_RIGHT.data >=500){ // se uno dei due sensori è sulla macchia d'olio


                stato.data = 1;
                stato_linea->publish(stato);

                if(GS_LEFT.data < 500 && GS_RIGHT.data >= 500){
                ...
                else if(GS_LEFT.data >= 500 && GS_RIGHT.data < 500){
                ...
                if(GS_middle.data<=300){

                    RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "È stato trovato un ostacolo");

                }
                else if(GS_light.data <= 10){
                    
                    RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Illuminazione inadeguata");
