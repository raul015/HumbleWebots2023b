...
# Variabili globali per il servizio
...
# Variabile globale Booleana per segnalare l'accettazione della richiesta
...
for i in range(8): # Settaggio valori iniziali per la chiamata di simulazione
    ...
    # Riempimento di variabili globali...
...
class MyRobotDriver:
    ...
    def step(self): # Funziona la lettura dei dati ottenuti dal sensore ....    # Inizialmente Goal = False, Homing inizialmente False
        ...
        # Homing = True ---> quindi è nella posizione di setup
