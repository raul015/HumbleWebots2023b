...
class Pioneer2Driver:
    ...
    def init(self, webots_node, properties): 
        ...
        self.__node.get_logger().info('  Pioneer2 is supervisor? ' + str(self.__robot.getSupervisor()))
        
        # Prova 
        
        # self.__node.get_logger().info('self.__robot: ' + str(self.__robot))

        # self.luce = self.__robot.getSelf().getFromDef('PointLight')
        
        # self.__node.get_logger().info('stampo luce: ' + str(self.luce()))

        # self.__node.get_logger().info('webots node: ' + str(webots_node))
